...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            explorer::get_theorem_list,
            explorer::get_theorem_list_page_of_header,
            explorer::get_theorem_list_page_of_comment,
            explorer::get_theorem_list_page_of_constant,
            explorer::get_theorem_list_page_of_variable,
            explorer::get_theorem_list_page_of_floating_hypothesis,
            explorer::get_theorem_list_page_of_theorem,
            ...
            metamath::mm_parser::close_metamath_database,
            local_state::comment::get_comment,
            local_state::comment::get_comment_mmp_format,
            local_state::comment::write_comment_mmp_format_to_file,
            local_state::constant::get_constant_statement,
            local_state::constant::get_constant_mmp_format,
            local_state::constant::write_constant_mmp_format_to_file,
            local_state::variable::get_variable_statement,
            local_state::variable::get_variable_mmp_format,
            local_state::variable::write_variable_mmp_format_to_file,
            local_state::floating_hypothesis::get_floating_hypothesis_page_data,
            local_state::floating_hypothesis::get_floating_hypothesis_mmp_format,
            local_state::floating_hypothesis::write_floating_hypothesis_mmp_format_to_file,
            local_state::theorem::get_theorem_page_data,
            local_state::theorem::get_theorem_mmp_format,
            local_state::theorem::write_theorem_mmp_format_to_file,
            local_state::header::get_header_representation,
            local_state::header::get_header_page_data,
            local_state::header::get_header_mmp_format,
            local_state::header::write_header_mmp_format_to_file,
            local_state::html_representation::get_html_representations,
        ])
...
pub enum Error {
    ...
    UnfinishedTheoremError,  // Returned if you try to add an unfisined theorem to the database
    AddingToInnerScopeError, // Returned if you try to add a statement between 2 statements sharing a scope
