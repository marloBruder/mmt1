...
{#each descriptionParsed as descriptionParsedSegement}
  ...
  {:else if descriptionParsedSegement.discriminator == "DescriptionLabel"}
    <TheoremLink label={descriptionParsedSegement.label} theoremNumber={descriptionParsedSegement.theoremNumber} openInNewTab={openLinksInNewTab} {externalWindow}></TheoremLink>
